...
public class BucketsApi {
     ...
     * @param preserveSourceProperties Whether source properties like identifier should be kept (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call createBucketCall(Bucket body, Boolean preserveSourceProperties, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call createBucketValidateBeforeCall(Bucket body, Boolean preserveSourceProperties, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling createBucket(Async)");
        }
        
        com.squareup.okhttp.Call call = createBucketCall(body, preserveSourceProperties, progressListener, progressRequestListener);
        return call;
     ...
     */
    public Bucket createBucket(Bucket body, Boolean preserveSourceProperties) throws ApiException {
        ApiResponse<Bucket> resp = createBucketWithHttpInfo(body, preserveSourceProperties);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Bucket> createBucketWithHttpInfo(Bucket body, Boolean preserveSourceProperties) throws ApiException {
        com.squareup.okhttp.Call call = createBucketValidateBeforeCall(body, preserveSourceProperties, null, null);
     ...
     */
    public com.squareup.okhttp.Call createBucketAsync(Bucket body, Boolean preserveSourceProperties, final ApiCallback<Bucket> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createBucketValidateBeforeCall(body, preserveSourceProperties, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Bucket>(){}.getType();
