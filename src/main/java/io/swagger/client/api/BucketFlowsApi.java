...
import io.swagger.client.model.VersionedFlowDifference;
...
public class BucketFlowsApi {
     ...
     * @param preserveSourceProperties Whether source properties like author should be kept (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call createFlowVersionCall(VersionedFlowSnapshot body, String bucketId, String flowId, Boolean preserveSourceProperties, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
        ...
        List<Pair> localVarQueryParams = new ArrayList<Pair>();
        List<Pair> localVarCollectionQueryParams = new ArrayList<Pair>();
        if (preserveSourceProperties != null)
        localVarQueryParams.addAll(apiClient.parameterToPair("preserveSourceProperties", preserveSourceProperties));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call createFlowVersionValidateBeforeCall(VersionedFlowSnapshot body, String bucketId, String flowId, Boolean preserveSourceProperties, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
        ...
        com.squareup.okhttp.Call call = createFlowVersionCall(body, bucketId, flowId, preserveSourceProperties, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public VersionedFlowSnapshot createFlowVersion(VersionedFlowSnapshot body, String bucketId, String flowId, Boolean preserveSourceProperties) throws ApiException {
        ApiResponse<VersionedFlowSnapshot> resp = createFlowVersionWithHttpInfo(body, bucketId, flowId, preserveSourceProperties);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<VersionedFlowSnapshot> createFlowVersionWithHttpInfo(VersionedFlowSnapshot body, String bucketId, String flowId, Boolean preserveSourceProperties) throws ApiException {
        com.squareup.okhttp.Call call = createFlowVersionValidateBeforeCall(body, bucketId, flowId, preserveSourceProperties, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call createFlowVersionAsync(VersionedFlowSnapshot body, String bucketId, String flowId, Boolean preserveSourceProperties, final ApiCallback<VersionedFlowSnapshot> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createFlowVersionValidateBeforeCall(body, bucketId, flowId, preserveSourceProperties, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<VersionedFlowSnapshot>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
